...
\item \hl{ Causal Inference in Natural Language Processing: Estimation, Prediction, Interpretation and Beyond.} Amir Feder, \textbf{Katherine~A.~Keith}, Emaad Manzoor, Reid Pryzant, Dhanya Sridhar, Zach Wood-Doughty, Jacob Eisenstein, Justin Grimmer, Roi Reichart, Margaret E. Roberts, Brandon M. Stewart, Victor Veitch, Diyi Yang. \emph{Transactions of the Association for Computational Linguistics (TACL)}. 2022.
...
%highlight
\item \hl{Paying Attention to the Algorithm Behind the Curtain: Bringing Transparency to YouTube's Demonetization Algorithms.} Arun Dunna, \textbf{Katherine A. Keith}, Ethan Zuckerman, Narseo Vallina-Rodriguez, Brendan O'Connor, Rishab Nithyanand. In \emph{ACM Conference On Computer-Supported Cooperative Work And Social Computing (CSCW)}. 2022.
...
\begin{itemize}
  % highlight 
  \item \hl{CSCI 104: Understanding Data Through Computation (Williams College, Fall 2022)}
...
\begin{itemize}
  %highlight 
\item \hl{Young Investigator Grant from the Allen Institute of Artificial Intelligence (\$100,000). November 2022.} 
...
\begin{itemize}
% highlight 
\item \hl{Williams College's Statistics Colloquium---October 19, 2022.}
...
\item \hl{Underrepresented Identities in Computer Science (UniCS) Faculty Mentor, Computer Science Department, 2022-2023 AY }
\end{rSubsection}

\begin{rSubsection}{Research Community Leadership Roles}{}{}{}
% highlight 
\item \hl{Co-organizer, \emph{NLP+CSS} workshop at EMNLP. December 7, 2022.} 
