...
Machine Learning (in progress), Deep Learning (in progress), Probabilistic Graphical Models, Database Design \& Implementation, Statistical Machine Learning, Introduction to Natural Language Processing, Advanced Probability \& Statistics, Real Analysis, Abstract Algebra, Game Theory, Numerical Analysis, Differential Equations, Linear Algebra 
\end{rSection}
